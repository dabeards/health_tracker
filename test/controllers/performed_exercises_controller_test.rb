...
class PerformedExercisesControllerTest < ActionController::TestCase
  ...
  test "should create performed_exercise" do
    assert_difference('PerformedExercise.count') do
      post :create, performed_exercise: { burned_calories: @performed_exercise.burned_calories, exercise_date: @performed_exercise.exercise_date }
    end
  ...
  test "should update performed_exercise" do
    patch :update, id: @performed_exercise, performed_exercise: { burned_calories: @performed_exercise.burned_calories, exercise_date: @performed_exercise.exercise_date }
    assert_redirected_to performed_exercise_path(assigns(:performed_exercise))
  end
